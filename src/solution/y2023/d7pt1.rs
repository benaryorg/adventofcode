...
///
/// ```
/// # use adventofcode::solution::{ y2023::d7pt1::Solution, Solution as S };
/// # env_logger::init();
/// let input = "\
///     32T3K 765\n\
///     T55J5 684\n\
...
///     KTJJT 220\n\
///     QQQJA 483";
/// assert_eq!(Solution::new(input.to_string()).solve().unwrap(), "6440");
/// ```
pub struct Solution
{
	input: String,
	...
	fn solve(&self) -> Result<String>
	{
		...
		let players = self.input.lines()
			.map(|line|
			{
				...
				let cards = cards.parse::<Set>().context(Error::AocParsing)?;
